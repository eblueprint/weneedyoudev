...
";
$to = "nottingham@quotientclinical.com,recruitment@quotientbioresearch.com,enquiries@awardmarketing.co.uk,webmaster@weneedyou.co.uk";//<== update the email address
...
SendHTMLEMail(2,$email,$email_from,$email_subject,"Dear",$salutation,$lastname);
