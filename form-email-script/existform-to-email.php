...
";
//$to = "nottingham@quotientclinical.com,recruitment@quotientclinical.com,annward071@gmail.com,enquiries@awardmarketing.co.uk,annwardtest@gmail.com";//<== update the email address
$to = "garry.bain@gmail.com";//<== update the email address
$headers = "From: QUOTIENT CLINICAL Website Form <nottingham@quotientclinical.com> \r\n";
