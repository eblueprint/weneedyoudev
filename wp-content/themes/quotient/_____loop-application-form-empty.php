...
function checkMyInputs(value, field){	
  if (value == '') {
      ...
      return true;
                        	...
                        	<form id="fullapp" method="post" action="http://weneedyou.co.uk/form-email-script/fullform-to-email.php" novalidate> 
...
<!-- add class="jNice" for jquery styles -->
				...
				<label>Are you pregnant &amp; lactating?*</label><br />
                    ...
                    <div id="inlinepregerror" style="display: none; clear:left;" class="msg red">If you are pregnant and breastfeeding then you would not be eligible to participate in our studies. Thank your for your interest in Quotient Clinical and for starting the application process.</div>
...
<input name="surgery" value="No" type="radio" class="styled" /></p>
      ...
      <p id="surgery-error" class="msg red" style="display: none;">You are ineligible at the moment but if your situation changes please feel free to apply once you have been registered for 12 months with a GP surgery.</p>
								...
								<div style="float: right;">
                                <label>How long have you suffered with Asthma?8</label> <input name="howlongasthma" placeholder="" type="text" class="sml" data-bvalidator="checkMyInputs[1],valempty" data-bvalidator-msg="Please complete this input"/>
...
<p class="msg">For the purpose of the Data Protection Act 1998 (the Act), the data controller is QUOTIENT BIORESEARCH GROUP LIMITED of Newmarket Road, Fordham, Cambridgeshire CB7 5WW.</p>
                                ...
                                <p class="msg">By applying for admission to our volunteer panel, you are not making a commitment to go on a clinical trial, but simply expressing an interest to find out more. I also understand that Quotient Clinical does not guarantee that I will be asked to participate in any study.</p>
