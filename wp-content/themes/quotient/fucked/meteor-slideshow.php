		...
		while ( $meteor_loop->have_posts() ) : $meteor_loop->the_post(); ?>
			...
			<div class="mslide mslide-<?php echo $meteor_count; ?>">
				...
				if ( get_post_meta( $post->ID, "slide_url_value", $single = true ) != "" ): ?>
                    ...
                    <a href="<?php echo get_post_meta( $post->ID, "slide_url_value", $single = true ); ?>" title="<?php the_title(); ?>"><img src="/wp-content/themes/quotient/images/findoutmoreb.png" alt="Find out more" id="findoutmore" /></a>
