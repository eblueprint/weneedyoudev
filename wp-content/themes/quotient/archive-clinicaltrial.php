...
<?php while ( have_posts() ) : the_post(); ?>
        ...
        $dates = $custom["clinicaltrialinfo_dates"][0];
        $payment = $custom["clinicaltrialinfo_payment"][0];
		$shortdesc = $custom["clinicaltrialinfo_short_description"][0];
		$studycode = $custom["clinicaltrialinfo_study_code"][0];
        ?>
