...
$(window).load(function(){
 ...
 if ($(this).css('backgroundImage').substr(-15,2) == 'un') {
   $('.step-heading h2').css('backgroundImage','url(/wp-content/themes/quotient-mobile/images/fquestion-up-bg.png)');
...
if ($('#bmi-select').val() == "feetlbs") {
  $('input[name=calcval]').attr('readonly','readonly');
				...
				<input type="hidden" name="callback" value="<?php echo $_POST['callback']; ?>">
							<br />
                                <select name="hear" value="<?php echo $_POST['hear']; ?>" class="styled" id="select-hear" data-bvalidator="required" data-bvalidator-msg="Please select.">
				<?php $hear = $_POST["hear"];?>
...
<?php if ($gender == Female)  { ?>
                ...
                <div style="float: none; display: none;" id="pregnant">
...
<?php /*                                <li id="dob">
                                ...
                                <input name="dob" class="date-pick" type="text" placeholder="dd/mm/yyyy" value="<?php echo $_POST['dob']; ?>" data-bvalidator="required" data-bvalidator-msg="Please enter your date of birth." />
                                </li> */ ?>
...
if ( $("#bmi").val().length > 0 )
{
  $("#metreskg").css("display", "block");
                                ...
                                <label class="blue">Height in cm:</label> <INPUT TYPE=TEXT NAME=height  SIZE=10 onFocus="this.form.height.value=''" value="<?php echo $_POST["height"];?>"><br />
                                <label class="blue">Weight in kg:</label> <INPUT TYPE=TEXT NAME=weight  SIZE=10 onFocus="this.form.weight.value=''" value="<?php echo $_POST["weight"];?>"><br />
                                <INPUT TYPE="button" VALUE="Calculate" onClick="computeform(this.form)"><br />
                                Your result: <INPUT TYPE=TEXT NAME=bmi id="bmi"    data-bvalidator="digit,required" data-bvalidator-msg="Please tell us your BMI" SIZE=8 value="<?php echo $_POST["bmi"];?>" readonly="readonly" ><br />
                                </div><!-- /metreskg -->
                                    <p class="msg">If your BMI is under 18 or over 33, typically you will be ineligible to become a volunteer on our panel.</p>

   <label style="display: none;">Know your BMI? </label> <INPUT TYPE="TEXT" style="display: none;" name="bmiknown" value="<?php // echo $_POST["bmiknown"];?>" id="bmiknown"><br/>
...
<br /><br />
				...
				?>
                                ...
                                <p id="alcohol-no"><input name="alcohol" value="No" type="radio" class="styled" <?php if ($drinkno == No) echo 'checked'; ?> data-bvalidator="required" data-bvalidator-msg="Please tell us if you<br />drink alcohol." /> <label for="no">No</label></p>
                                <div class="clear"> </div>
<script type="text/javascript">
$(document).ready(function(){
