...
$(window).load(function(){
 ...
 $('#togglestep1 h2').css('backgroundImage','url(/wp-content/themes/quotient-mobile/images/question-down-bg.png)');
 $('.step-heading h2').click(function(){
 if ($(this).css('backgroundImage').substr(-15,2) == 'un') {
   $('.step-heading h2').css('backgroundImage','url(/wp-content/themes/quotient-mobile/images/question-up-bg.png)');
   $(this).css('backgroundImage','url(/wp-content/themes/quotient-mobile/images/question-down-bg.png)');
  } else {
   $('.step-heading h2').css('backgroundImage','url(/wp-content/themes/quotient-mobile/images/question-up-bg.png)');
  }
 });
...
function checkMyInputs(value, field){	
  if (value == '') {
      ...
      return true;
                        	...
                        	<form id="fullapp" method="post" action="http://www.weneedyou.co.uk/form-email-script/fullform-to-email.php" novalidate> 
...
<!-- add class="jNice" for jquery styles -->
                            ...
                            <div id="stepone" name="step" class="step" style="display: block;">
                                <select name="hear" value="" class="styled" id="select-hear" data-bvalidator="required" data-bvalidator-msg="Please select.">
								...
								<div id="hear-mobile">Please make your selection and then press 'Done'</div>
								<br /><br />
                ...
                <label>Gender*</label><br />
                               ...
                               <p id="gender-female"> <input name="gender" value="Female" type="radio" class="styled" data-bvalidator="required" data-bvalidator-msg="Please select either<br />male or female." /> <label for="female">Female</label></P>
				</div><!-- /gender -->
                <div style="float: left; width: 410px; display:none;" id="pregnant">
				<label>Are you pregnant &amp; lactating?*</label><br />
                                <p id="pregnantyes"><input name="pregnant" value="Yes" type="radio" class="styled" /> <label for="yes">Yes</label></p>
                                <p id="pregnantno"><input name="pregnant" value="No" type="radio" class="styled" /> <label for="no">No</label></p>
                </div><!-- /pregnant -->
								<div id="inlinepregerror" class="msg red">If you are pregnant and breastfeeding then you would not be eligible to participate in our studies. Thank your for your interest in Quotient Clinical and for starting the application process.</div>
                                </li>
                                <li id="dob">
                                ...
                                <input name="contactnumber" value="" type="text" placeholder="Preferred contact number*" class="lrg" data-bvalidator="digit,required" data-bvalidator-msg="Please provide your contact number as numbers only." /><br />
                                ...
                                <input name="city" value=""type="text" placeholder="City" class="lrg" /><br />
                            ...
                            <ul>
                                ...
                                <label class="blue">Height in ft:</label> <INPUT TYPE="TEXT" NAME="feet" size="5" value="" class="sml"><br />
                
                
                                <label class="blue">and inches:</label> <INPUT TYPE="TEXT" NAME="inches" size="5" value="" class="sml"><br />
                

                                <label class="blue">Weight in stones:</label> 
<INPUT TYPE="TEXT" NAME="stones" size="5" value="<?php echo $_POST["stones"];?>" class="sml"><br/>
<label class="blue">and pounds:</label> <INPUT TYPE="TEXT" NAME="pounds" size="5" value="<?php echo $_POST["pounds"];?>" class="sml"><br />
                                ...
                                <label>Your result:</label> <INPUT TYPE="TEXT" name="calcval" value="" data-bvalidator="required" data-bvalidator-msg="Please complete your BMI" readonly="readonly"><br/>
                
                				</div><!-- /feetlbs -->
                                
                                <div id="metreskg" style="display: none;">
                                <label class="blue">Height in cm:</label> <INPUT TYPE=TEXT NAME=height  SIZE=10 onFocus="this.form.height.value=''" value=""><br />
                                <label class="blue">Weight in kg:</label> <INPUT TYPE=TEXT NAME=weight  SIZE=10 onFocus="this.form.weight.value=''" value=""><br />
                                <INPUT TYPE="button" VALUE="Calculate" onClick="computeform(this.form)"><br />
                                Your result: <INPUT TYPE=TEXT NAME=bmi  SIZE=8 value="" readonly="readonly" data-bvalidator="required" data-bvalidator-msg="Please tell us your BMI"><br />
                                </div><!-- /metreskg -->
...
<br /><br />
                                ...
                                <p id="alcohol-no"><input name="alcohol" value="No" type="radio" class="styled" data-bvalidator="required" data-bvalidator-msg="Please tell us if you<br />drink alcohol." /> <label for="no">No</label></p>
                                <div class="clear"> </div>
<script type="text/javascript">
$(document).ready(function(){
...
if (unitsperweek == 'more')
{
  $("#alcohol-amount").css("display", "block");
                                ...
                                <div id="diet-error" style="display: none; clear: both;">
					...
					<div id="other-clinics" style="display: none;">
                        ...
                        <input name="other-clinics" id="otherclinics" type="text" placeholder="" class="lrg" value=""/>
                            ...
                            <ul>
								...
								<p id="surgery-error" class="msg red" style="display: none; clear: both;">You are ineligible at the moment but if your situation changes please feel free to apply once you have been registered for 12 months with a GP surgery.</p>
                                <div class="clear"> </div>
                                </li>
                                <li>
								...
								<div id="allergies-details" style="display: none; clear: both;">
                                
                                <div style="float: none;">
                                <label>Please tell us which allergies you have</label>
                                </div><!-- /left -->
								<div style="float: none;">
								...
								<div style="float: none; clear: both;">
                                <label><br />Date (month/year if known)</label>
                                </div>
                                <div style="float: none;">
								...
								<div id="asthma-error" style="display: none; clear: both;">
                                ...
                                <label>How long have you suffered with Asthma?</label> <input name="howlongasthma" placeholder="" type="text" class="sml" data-bvalidator="checkMyInputs[1],valempty" data-bvalidator-msg="Please complete this input"/><br />
								...
								<div id="asthma-med-details" style="display:none; clear: both;">
                                ...
                                <div id="asthma-clinic-details" style="display:none; clear: both;">
                            ...
                            <div id="diabetes-error" style="display:none; clear: both;">
								...
								<span id="diabetes-input" style="display: none; clear: both;">
								...
								<div id="skin-details" style="display: none; clear: both;">
                                <label>Details: </label> 
                            ...
                            <ul>
                                ...
                                <p><label for="no">No</label> <input name="heart" value="No" type="radio" class="styled" data-bvalidator="required" data-bvalidator-msg="Please select yes or no." /></p>
                                <div class="clear"> </div>
                                ...
                                <p><label for="no">No</label> <input name="stomach" value="No" type="radio" class="styled" data-bvalidator="required" data-bvalidator-msg="Please select yes or no." /></p>
                                <div class="clear"> </div>
                                ...
                                <p><label for="no">No</label> <input name="migraines" value="No" type="radio" class="styled" data-bvalidator="required" data-bvalidator-msg="Please select yes or no." /></p>
                                <div class="clear"> </div>
                                ...
                                <p><label for="no">No</label> <input name="urinary" value="No" type="radio" class="styled" data-bvalidator="required" data-bvalidator-msg="Please select yes or no." /></p>
                                <div class="clear"> </div>
                                ...
                                <p><label for="no">No</label> <input name="nervous" value="No" type="radio" class="styled" data-bvalidator="required" data-bvalidator-msg="Please select yes or no." /></p>
                                <div class="clear"> </div>
                                ...
                                <p><label for="no">No</label> <input name="muscle" value="No" type="radio" class="styled" data-bvalidator="required" data-bvalidator-msg="Please select yes or no." /></p>
                                <div class="clear"> </div>
                                ...
                                <p><label for="no">No</label> <input name="eye" value="No" type="radio" class="styled" data-bvalidator="required" data-bvalidator-msg="Please select yes or no." /></p>
                                <div class="clear"> </div>
                                ...
                                <p><label for="no">No</label> <input name="ear" value="No" type="radio" class="styled" data-bvalidator="required" data-bvalidator-msg="Please select yes or no." /></p>
                                <div class="clear"> </div>
                                ...
                                <p><label for="no">No</label> <input name="tropical" value="No" type="radio" class="styled" data-bvalidator="required" data-bvalidator-msg="Please select yes or no." /></p>
                                <div class="clear"> </div>
                                ...
                                <p><label for="no">No</label> <input name="otherproblems" value="No" type="radio" class="styled" data-bvalidator="required" data-bvalidator-msg="Please select yes or no." /></p>
                                <div class="clear"> </div>
                            ...
                            <ul>
                            	<li>
                                I have read and agreed to the Quotient Clinical <a href="/wp-content/themes/quotient/privacy.html" target="_blank" id="privacy">Privacy Policy</a>*<br /><br />
...
<p class="msg">For the purpose of the Data Protection Act 1998 (the Act), the data controller is QUOTIENT BIORESEARCH GROUP LIMITED of Newmarket Road, Fordham, Cambridgeshire CB7 5WW.</p>
                                ...
                                <p class="msg">By applying for admission to our volunteer panel, you are not making a commitment to go on a clinical trial, but simply expressing an interest to find out more. I also understand that Quotient Clinical does not guarantee that I will be asked to participate in any study. <span style="float: right; width: 35px;"><input name="privacypol" value="Yes" type="checkbox" class="styled" data-bvalidator="required" data-bvalidator-msg="Required" /></span></p>
