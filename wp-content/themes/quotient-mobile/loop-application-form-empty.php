...
$(document).ready(function(){
  ...
  $("#pregnantyes").click(function() {
    $("#inlinepregerror").show();
  });
  $("#pregnantno").click(function() {
    $("#inlinepregerror").hide();
  });
...
<!-- add class="jNice" for jquery styles -->
				...
				<label>Are you pregnant or lactating?*</label><br />
								...
								<div id="inlinepregerror" style="clear: left;" class="msg red">If you are pregnant or lactating then you would not be eligible to participate in our studies. Thank you for your interest in Quotient Clinical and for starting the application process.</div>
                                </li>
                              <?php /*  <li id="dob">
...
<select name="dob_year" data-bvalidator="number,required" data-bvalidator-msg="Please select your year of birth">
  ...
  ?>
                                ...
                                <input name="contactnumber" value="" type="text" placeholder="Preferred contact number*" class="lrg" data-bvalidator="required" data-bvalidator-msg="Please provide your contact number." /><br />
                    ...
                    <option value="">Ethnic Origin*</option>
                                ...
                                <input name="city" value=""type="text" placeholder="Town/City*" data-bvalidator="required" data-bvalidator-msg="Please enter your town/city." class="lrg" /><br />
...
<label class="blue">and pounds:</label> <INPUT TYPE="TEXT" NAME="pounds" size="5" value="<?php echo $_POST["pounds"];?>" class="sml"><br />
                                ...
                                <label>Your result:</label> <INPUT TYPE="TEXT" name="calcval" value="" data-bvalidator="digit,required" data-bvalidator-msg="Please complete your BMI" readonly="readonly"><br/>
                                ...
                                <label style="display: none;">Know your BMI? </label> <INPUT style="display: none;" TYPE="TEXT" name="bmiknown" value="" data-bvalidator="digit" data-bvalidator-msg="Please enter your BMI"><br/>
